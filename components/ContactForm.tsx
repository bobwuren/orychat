 ...
 * Validation locale, états d'envoi, feedback succès/erreur.
...
export default function ContactForm() {
  ...
  return (
    <div
      className="p-5 sm:p-6 lg:p-8 border rounded-xl sm:rounded-2xl"
      style={{
    ...
    >
      <h2
        className="font-display text-lg sm:text-xl font-bold mb-1"
        style={{ color: "var(--color-text-primary)" }}
      >
        Envoyez-nous un message
      </h2>
      <p
        className="text-sm mb-5 sm:mb-7"
      ...
      {status === "success" && (
        <div
          className="flex items-start gap-3 sm:gap-4 p-4 sm:p-5 border rounded-xl mb-5 sm:mb-6 animate-scale-in"
          style={{
      ...
      {status === "error" && (
        <div
          className="flex items-start gap-3 p-4 border rounded-xl mb-5 sm:mb-6"
          style={{
      ...
      >
        ...
        <button
          ...
          className="group relative w-full flex items-center justify-center gap-2.5 px-6 py-3 sm:py-3.5 rounded-xl text-sm font-bold transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed overflow-hidden"
